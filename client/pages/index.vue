                  ...
                  <div>
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                        <div class="a-row a-spacing-small">
                          ...
                          <nuxt-link :to="`/products/${product._id}`" class="a-link-normal">
                            <h2 class="a-size-medium">
                              ...
                              <span class="a-letter-space"></span>
                              <span class="a-size-small a-color-secondary">2021</span>
                            </h2>
                          </nuxt-link>
                        </div>
                        ...
                        <!-- Author's name -->
                        <div class="a-row a-spacing-small">
                          <span class="a-size-small a-color-secondary">Owner of Product</span>
                        ...
                        <!-- Shipment -->
                        <div class="a-row">
                          <span class="a-size-small">Ships to AMU Students</span>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-7">
                            ...
                            <!-- Audible Trial -->
                            <div class="a-row a-spacing-none">
                              <span class="a-size-small a-color-secondary">Soft Copy Availabile</span>
                            </div>
                            <hr />
