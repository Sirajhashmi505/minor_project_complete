  ...
  <div class="container-fluid">
    <div class="shipping-address">
      <div class="navbarShipping a-spacing-large">
        <nuxt-link to="/">
          <img src="/img/icon.jpeg" class="img-fluid" />
        </nuxt-link>
      </div>
      <div class="a-row">
              ...
              <div class="a-box-inner">
                <div class="a-row a-spacing-micro">
                  <nuxt-link to="/payment">
                    <span class="a-button-place-order">Place your order in ruppees</span>
                  </nuxt-link>
                </div>
                <div class="a-row a-spacing-small a-size-small a-text-center">
                  By placing your order, you agree to AMU Affinity's
                  ...
                  <div id="tfx-header">
                    <div class="a-box a-alert-info a-spacing-small">
                      <div class="a-box-inner alert-info-no-icon">
                        <strong>
                          Affinity Currency Converter is Enabled. &nbsp;
                          <a
                            href="#"
                            class="a-size-mini"
                          >Learn More</a>
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    ...
                    <div class="row">
                     ...
                     <div class="col-sm-6">Shipping & handling:</div>
                      <div class="col-sm-6 text-right">₹{{ shippingPrice }}</div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">₹ {{getCartTotalPriceWithShipping}}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">₹ {{getCartTotalPriceWithShipping}}</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        >For an item sold by Affinity.com: When you click the "Place your order" button, we'll send you an email message acknowledging receipt of your order. Your contract to purchase an item will not be complete until we send you an email notifying you that the item has been shipped.</p>
          <div class="a-color-secondary a-size-mini">
          <p class="a-color-secondary a-size-mini">
            Within 30 days of delivery, you may return new, unopened merchandise in its original condition. Exceptions and restrictions apply. See AMU Affinity.com's
            <a
              href="#"
            >Returns Policy</a>
            <br />
            <br />Go to the
            <a href="/">Affinity.com homepage</a> without completing your order.
          </p>
        </div>
      </div>
      <hr />
      <p class="a-size-small a-text-center a-color-secondary" data-testid>
        <a href="#">Conditions of Use</a> |
        <a href="#">Privacy Notice</a> © 2021-Infinity, Affinity.com, Inc.
      </p>
    </div>
  </div>
  <!--/SHIPPING ADDRESS-->
