          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div class="authorFollow">
                ...
                <h1 class="authorFollowHeading">Owner Of the Item</h1>
            ...
            <div class="combinedBuyBox">
              <div class="buyBox">
                ...
                <div class="a-section a-spacing-small">
                  ...
                  <div class="a-section a-spacing-mini">Ships from and sold by AMU Affinity</div>
                </div>
                  ...
                  <div class="a-button-stack">
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                        ...
                        <input type="submit" name="submit.add-to-cart" class="a-button-input" />
                        <span class="a-button-text"><a href="/placeorder">Buy Now</a></span>
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div class="a-spacing-top-small">
                    <div class="a-section a-spacing-none">
                      <div class="a-section a-spacing-none a-spacing-top-mini">
                        This item shipts to
                        <b>AMU Student.</b>
                        <b>You will get this as soon as possible</b>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span class="a-size-small">Deliver to Aligarh</span>
                    </div>
                  </a>
                </span>
                <br />
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <form>
                        ...
                        <label for="test1">You can donate as well -> contact us</label>
                      </form>
                    </div>
                    <div class="float-right">
                      <span class="a-color-base offer-price a-text-normal"></span>
                    </div>
                  </div>
                </div>
              </div>
